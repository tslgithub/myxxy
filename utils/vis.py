...
def vis_keypoints(img, kps, kp_thresh=2, alpha=0.7):
    ...
    # print(dataset_keypoints.index,'***dataset_keypoints.index**********99999')
...
def vis_one_image(
    ...
    dataset_keypoints, _ = keypoint_utils.get_keypoints()
    kp_lines = kp_connections(dataset_keypoints)
    # print(kp_lines,'---keypoints-----------------------keypoints')

    if segms is not None and len(segms) > 0:
        # print('segms===', mask_util.decode(segms))
        masks = mask_util.decode(segms)
    ...
    for i in sorted_inds:
        ...
        ax.add_patch(
            plt.Rectangle((bbox[0], bbox[1]),
                          bbox[2] - bbox[0],
                          bbox[3] - bbox[1],
                          fill=False, edgecolor=new_edgecolor,
                          linewidth=2, alpha=1))
        ...
        if show_class:
            ax.text(
                ...
                family='serif',
                bbox=dict(
                    facecolor=new_edgecolor, alpha=1, pad=0, edgecolor='none'),
                color='white')
            # print('***************************************',(classes[i]))
        ...
        # show keypoints  nononononononono
        if keypoints is not None and len(keypoints) > i:
            kps = keypoints[i]
            plt.autoscale(False)
            for l in range(len(kp_lines)):
