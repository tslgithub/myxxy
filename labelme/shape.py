...
DEFAULT_HVERTEX_FILL_COLOR = QtGui.QColor(0, 255, 0,128)

DEFAULT_LINE_RIGHT_COLOR = QtGui.QColor(0, 0, 255, 128)
DEFAULT_LINE_FAULT_COLOR = QtGui.QColor(255, 0, 0, 128)
        ...
        if self.points:    #
            ...
            if self.selected==False:
                if self.label is not None:
                    if self.label.find("right") >= 0:
                        color = DEFAULT_LINE_RIGHT_COLOR
                    elif self.label.find("fault") >= 0:
                        color = DEFAULT_LINE_FAULT_COLOR
